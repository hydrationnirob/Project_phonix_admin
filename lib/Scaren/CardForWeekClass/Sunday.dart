                        ...
                        Get.defaultDialog(
                          ...
                          onConfirm: () async {
                            if (_formKey.currentState != null && _formKey.currentState!.validate()) {
                              await FirebaseFirestore.instance.collection('Sunday').doc(documents[index].id).update({
                          ...
                          actions: [
                            Padding(
                              ...
                              child: IconButton(onPressed: (){
                                ...
                                FirebaseFirestore.instance.collection('Sunday').doc(documents[index].id).delete();
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_formKey.currentState != null && _formKey.currentState!.validate()) {
                          ...
                          // Example:
                          await FirebaseFirestore.instance.collection('Sunday').add({
