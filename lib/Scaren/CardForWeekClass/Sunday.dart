...
class _SundayWeekClassState extends State<SundayWeekClass> {
  ...
  void initState() {
    ...
    wednesdayData = FirebaseFirestore.instance
        ...
        .collection(DatabaseCollection.DaySunday)
        .orderBy("StartTime")
        .get();
  }
      ...
      body: Column(
        children: [
          Container(
            ...
            height: 150,
            child: Lottie.asset(
              'images/animation_lki1kf82.json',
              fit: BoxFit.cover,
            ),
          ),
          const SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    TextEditingController roomController =
                        TextEditingController(text: data['Room']);
                    TextEditingController startTimeController =
                        TextEditingController(text: data['StartTime']);
                    TextEditingController endTimeController =
                        TextEditingController(text: data['EndTime']);
                                ...
                                onPressed: () {
                                  ...
                                  setState(() {
                                    wednesdayData = FirebaseFirestore.instance
                                        ...
                                        .doc(DatabaseCollection.Section)
                                        .collection(
                                            DatabaseCollection.DaySunday)
                                        .orderBy("StartTime")
                                        .get();
                                  });
                                  Get.back();
                                  Get.snackbar("Delete",
                                      "Class Details Deleted Successfully",
