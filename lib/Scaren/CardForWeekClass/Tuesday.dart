...
class TuesdayWeekClass extends StatefulWidget {
  const TuesdayWeekClass({Key? key}) : super(key: key);

  @override
  State<TuesdayWeekClass> createState() => _TuesdayWeekClassState();
}

class _TuesdayWeekClassState extends State<TuesdayWeekClass> {
  ...
  void initState() {
    ...
    wednesdayData = FirebaseFirestore.instance
        ...
        .collection(DatabaseCollection.DayTuesday)
        .orderBy("StartTime")
        .get();
  }
                        ...
                        Get.defaultDialog(
                          ...
                          onConfirm: () async {
                            if (_formKey.currentState != null && _formKey.currentState!.validate()) {
                              await FirebaseFirestore.instance.collection(DatabaseCollection.Semester).doc(DatabaseCollection.Section).collection(DatabaseCollection.DayTuesday).doc(documents[index].id).update({
