...
class _ThursdayWeekClassState extends State<ThursdayWeekClass> {
  ...
  void initState() {
    ...
    wednesdayData = FirebaseFirestore.instance
        ...
        .collection(DatabaseCollection.DayThursday)
        .orderBy("StartTime")
        .get();
  }
                        ...
                        Get.defaultDialog(
                          ...
                          onConfirm: () async {
                            if (_formKey.currentState != null && _formKey.currentState!.validate()) {
                              await FirebaseFirestore.instance.collection(DatabaseCollection.Semester).doc(DatabaseCollection.Section).collection(DatabaseCollection.DayThursday).doc(documents[index].id).update({
                              ...
                              child: IconButton(onPressed: (){
                                ...
                                setState(() {
                                  FirebaseFirestore.instance
                                      ...
                                      .doc(DatabaseCollection.Section)
                                      .collection(
                                      DatabaseCollection.DayThursday)
                                      .orderBy("StartTime")
                                      .get();
                                });
                                Get.back();
